...
## The names of anyone you worked with on this project: Prashant Toteja
...
def get_user_tweets(input_string):
	returnedList = []
...
# - text (containing the Ctext of the Tweet)
